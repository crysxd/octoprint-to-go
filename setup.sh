...
mkdir -p nginx/certs
sudo openssl req -x509 -nodes -days 10000 -newkey rsa:2048 -subj "/C=$COUNTRY/CN=$HOST" -addext "subjectAltName = DNS:$HOST" -key nginx/certs/nginx-selfsigned.key -out nginx/certs/nginx-selfsigned.crt
